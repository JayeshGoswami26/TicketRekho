...
import MCustomerTable from './MCustomerTable';
...
const SellerMDetails: React.FC = () => {
  ...
  useEffect(() => {
    axios.get(`${Urls.MprofileDetailUrl}/${id}`,{
        headers: {
  ...
  return (
    <>
      ...
      <div className="mt-4 grid grid-cols-1 gap-4 md:mt-6 md:gap-6 2xl:mt-7.5 2xl:gap-7.5">
        ...
        <MCustomerTable sellerId={id ?? ''} />
      </div>
    </>
  );
};

export default SellerMDetails;
