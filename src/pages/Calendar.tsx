...
// // Define the interface for the ticket count data from the API
...
//     try {
//       const response = await axios.get<{ data: TicketCount[] }>(
//         `${Urls.calender}`,
//         {
//           headers: {
...
//         const date = new Date(current.date).getDate();
//         acc[date] = current.count;
//         return acc;
//       }, {} as TicketCountsMap);
...
//           </span>
//           <span className="time text-sm font-medium text-black dark:text-white"></span>
//         </div>
//       </div>
//     ) : null;
//   };
