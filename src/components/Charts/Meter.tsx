...
const Meter: React.FC<{ todayTarget: number }> = ({ todayTarget }) => {
  ...
  return (
    <>
      <div className="rounded-sm border  p-5 shadow-default border-strokedark bg-boxdark sm:px-7.5 flex items-center justify-center">
        {/* <GaugeComponent
          className="w-full"
          //   arc={{
          //     nbSubArcs: 150,
        ...
        <GaugeComponent
          ...
          maxValue={25000} // Maximum value of the gauge
        />
        {/* <GaugeComponent
